...
3. Build a Docker image: `sudo docker build -t customers-api .`
4. Run your Docker image: `docker run -p 8080:8080 customers-api`
...
1. `capstan rmi customers-api; capstan build`
